...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar" style="background-color: white;">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('booking') }}" style="color: #333;">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('schedule') }}" style="color: #333;">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('notification') }}" style="color: #333;">
            ...
            <!-- Nav Item - Settings -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('setting') }}" style="color: #333;">
