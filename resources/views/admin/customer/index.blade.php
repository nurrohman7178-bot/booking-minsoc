                            ...
                            @forelse ($customer as $user)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        {{-- Detail --}}
                                        <a href="{{ route('customer.show', $user->id_pelanggan) }}" class="mr-2" title="Lihat">
                                            <i class="fas fa-eye text-dark"></i>
                                        </a>

                                        {{-- Edit --}}
                                        <a href="{{ route('customer.edit', $user->id_pelanggan) }}" class="mr-2" title="Edit">
                                            <i class="fas fa-edit text-primary"></i>
                                        </a>

                                        {{-- Delete --}}
                                        <a href="javascript:void(0)" title="Hapus"
                                            onclick="actionDestroy('{{ route('customer.destroy', $user->id_pelanggan) }}',
                                            '{{ $user->user->name }}')">
